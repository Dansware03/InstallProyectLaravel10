    ...
    <div class="accordion" id="mailConfigAccordion">
        <div class="accordion-item">
            <h2 class="accordion-header" id="headingMailConfig">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMailConfig" aria-expanded="false" aria-controls="collapseMailConfig">
                    <i class="fas fa-envelope me-2"></i>Configuración de Correo (Opcional)
                </button>
            </h2>
            <div id="collapseMailConfig" class="accordion-collapse collapse" aria-labelledby="headingMailConfig" data-bs-parent="#mailConfigAccordion">
                <div class="accordion-body">
                    <p class="text-muted">Configure cómo su aplicación enviará correos electrónicos. Puede omitir esto y configurarlo más tarde en su archivo <code>.env</code>.</p>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="mail_driver" class="form-label">Driver de Correo</label>
                            <select class="form-select form-select-sm" id="mail_driver" name="mail_driver">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" id="mail_host" name="mail_host" value="{{ old('mail_host', session('installer.environment.MAIL_HOST')) }}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label for="mail_port" class="form-label">Puerto SMTP</label>
                            <input type="number" class="form-control form-control-sm" id="mail_port" name="mail_port" value="{{ old('mail_port', session('installer.environment.MAIL_PORT')) }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="mail_username" class="form-label">Usuario SMTP</label>
                            <input type="text" class="form-control form-control-sm" id="mail_username" name="mail_username" value="{{ old('mail_username', session('installer.environment.MAIL_USERNAME')) }}">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="mail_password" class="form-label">Contraseña SMTP</label>
                            <input type="password" class="form-control form-control-sm" id="mail_password" name="mail_password" value="{{ old('mail_password', session('installer.environment.MAIL_PASSWORD')) }}">
                        </div>
                    </div>
                     <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="mail_encryption" class="form-label">Cifrado SMTP</label>
                            <select class="form-select form-select-sm" id="mail_encryption" name="mail_encryption">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control form-control-sm" id="mail_from_address" name="mail_from_address" placeholder="noreply@example.com" value="{{ old('mail_from_address', session('installer.environment.MAIL_FROM_ADDRESS')) }}">
                        </div>
                    </div>
                </div>
            </div>
